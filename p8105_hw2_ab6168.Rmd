...
Some ZIP codes might not be shown in the Zillow dataset because there may be very few rental properties in those zip codes. There may not be enough data for Zillow to compute the observed rent index.
